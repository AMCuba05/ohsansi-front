        ...
        <div className="container d-flex justify-content-center">
            <div className="card p-4">
                ...
                <h2 className="mb-3 mt-4">
                    Paso {stepsState.current}: Seleccionar Olimpiada
                </h2>
                <p className="text-muted mb-4">
                    Por favor, seleccione la olimpiada en la que desea inscribir
                    al estudiante. Una vez seleccionada, podrá completar el
                    formulario de registro correspondiente. Podrás elegir la
                    categoría adecuada más adelante en proceso de inscripción.
                </p>
                    ...
                    {selected && (
                        <Card className="mt-4">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <strong>
                                        Precio de inscripción por área:
                                    </strong>{' '}
                                    {selected.price} Bs
                                </Card.Text>
